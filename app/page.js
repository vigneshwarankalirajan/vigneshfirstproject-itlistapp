...
{/* SERVICE */}
  ...
  {/* SECTION HEADER */}
  <div className="mb-16">
    <h2 className="text-3xl font-bold text-gray-800 tracking-tight">OUR SERVICES</h2>
    <p className="text-xs tracking-[0.3em] text-gray-400 mt-2 uppercase font-semibold">
      Years of Expertise
    </p>
  </div>

  {/* SERVICES GRID */}
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 px-10 max-w-7xl mx-auto">
    
    {/* SERVICE 1 */}
    <div className="flex flex-col items-center">
      {/* Icon Circle */}
      <div className="w-24 h-24 bg-[#E87722] rounded-full flex items-center justify-center mb-6 shadow-sm hover:scale-105 transition-transform duration-300">
        <span className="text-white text-4xl">🔧</span> {/* Replace with SVG icon */}
      </div>
      {/* Title */}
      <h3 className="text-[13px] font-bold text-[#E87722] tracking-wider mb-6 uppercase">
        IT Services
      </h3>
      {/* List */}
...
<section className="relative bg-[#E87722] text-white py-12 text-center overflow-hidden">
  ...
  <div className="relative z-10">
    ...
    <p className="text-sm font-semibold opacity-70 tracking-widest uppercase mb-6">
      Tell Us About Your Project
    </p>

    <button className="border-2 border-white px-8 py-2 text-xs font-bold uppercase hover:bg-white hover:text-[#E87722] transition-colors">
      Contact Us
    </button>
  </div>
</section>
